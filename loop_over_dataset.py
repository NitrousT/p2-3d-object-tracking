...
exec_data = [] # options are 'load_image', 'pcl from rangeimgae' 
...
exec_visualization = ['show_tracks', 'make_tracking_movie'] # options are 'show_range_image', 'show_bev', 'show_pcl', 'show_labels_in_image', 'show_objects_and_labels_in_bev', 'show_objects_in_bev_labels_in_camera', 'show_tracks', 'show_detection_performance', ''
        ...
        if 'perform_tracking' in exec_list:
            ...
            if 'show_tracks' in exec_list:
                ...
                if 'make_tracking_movie' in exec_list:
                    ...
                    fname = "./output" + '/tracking%03d.png' % cnt_frame
